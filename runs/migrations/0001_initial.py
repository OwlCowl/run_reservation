# Generated by Django 3.1.3 on 2021-04-09 13:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='ultra', max_length=20)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='run_connection',
            field=models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, to='runs.rundetails'),
        ),
        migrations.CreateModel(
            name='Contacts',
            fields=[
